			...
			<view class="login-form">
				<view :class="['item',errorTips==1? 'error':'']">
					<view class="account">
						...
						<input type="text" @input="getInputVal" data-type="account" placeholder-class="inp-palcehoder" placeholder="Ingrese el numero de cuenta!"></input>
					</view>
				...
				<view class="operate">
					<view class="to-register" @tap="toLogin">Aun no tiene una cuenta?<text>Iniciar sesion></text></view>
				</view>
			</view>

			<view>
				<button class="authorized-btn" @tap="toRegister">Iniciar sesion</button>
