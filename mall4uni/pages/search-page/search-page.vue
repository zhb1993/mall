...
<view class="container">
  ...
  <view class="search-bar">
    <view class="search-box">
      <input placeholder="Buscar" class="sear-input" confirm-type="search" @confirm="toSearchProdPage" @input="getSearchContent" :value="prodName"></input>
      <image src="/static/images/icon/search.png" class="search-img"></image>
    </view>
    <text class="search-hint" @tap="goBackIndex">Cancelar </text>
  </view>
