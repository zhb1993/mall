...
<!-- 头部搜索区 -->
  ...
  <view class="search-bar">
    <view class="search-box" @tap="toSearchPage">
      ...
      <text class="sear-input">Buscar</text>
    </view>
  </view>
<!-- 滚动内容区 -->
  <view class="main">
    ...
    <scroll-view scroll-y="true" class="leftmenu">
      ...
      <view v-if="!categoryList || !categoryList.length" class="ca-empty">Ninguno</view>
    </scroll-view>
    <!-- 左侧菜单end -->
    ...
    <!-- <block wx:for='{{ productList}}' wx:key=''> -->
      ...
      <view v-if="!productList.length" class="cont-item empty">{{categoryList && categoryList.length ? 'Ninguno' : 'Ninguno'}}</view>
     <!-- </block> -->
    </scroll-view>
    <!-- 右侧内容end -->
    <!-- </block> -->
