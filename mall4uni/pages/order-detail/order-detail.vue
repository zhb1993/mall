...
<view class="container">
  ...
  <view class="order-detail">
        ...
        <view class="item-cont" @tap="toProdPage" :data-prodid="item.prodId">
          ...
          <view class="prod-info">
            ...
            <view class="prod-info-cont">
              <text class="number">Cantidad: {{item.prodCount}}</text>
    ...
    <view class="order-detail-footer" v-if="status==5||status==6">
      <text class="dele-order" v-if="status==5||status==6" @tap="delOrderList">Eliminar orden</text>
