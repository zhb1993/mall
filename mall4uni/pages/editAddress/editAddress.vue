...
<view class="container">
  ...
  <view class="input-box">
    <view class="section">
      <text>Consignar</text>
      <input placeholder="Nombre" type="text" maxlength="15" :value="receiver" @input="onReceiverInput"></input>
    </view>
    <view class="section">
      <text>Numero de Telefono</text>
      <input placeholder="Numero de Telefono" type="number"  :value="mobile" @input="onMobileInput"></input>
    </view>
    <view class="section" @tap="translate">
      ...
      <view class="animation-element-wrapper" :animation="animation" :style="'visibility:' + (show ? 'visible':'hidden')" @tap.stop="hiddenFloatView">
        <view class="animation-element" @tap.stop="nono">
          <text class="right-bt" @tap.stop="hiddenFloatView">Confirmar</text>
